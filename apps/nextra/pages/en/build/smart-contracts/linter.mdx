...
To suppress lint checks named `l1` and `l2`, you can add the attribute `#[lint::skip(l1, l2)]` to a function or a module. The linter will not perform the checks named `l1` and `l2` for that function or module.
